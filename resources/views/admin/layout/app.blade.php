            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="{{ asset('admins/img/DefaultImage.png') }}" alt="" style="width: 40px; height: 40px;">
                ...
                <div class="navbar-nav w-100">
                    ...
                    @auth
                         ...
                         <a href="{{ route('admin.agency-users.store') }}"  class="nav-item nav-link"><i class="fa fa-th me-2"></i>Agency User</a>
                        @endif
                    @endauth

                      @auth
                          @if(auth()->user()->role === 'AgencyUser')
                           <a href="{{ route('admin.agency-users.store') }}" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Complaints</a>
                        @endif
                    @endauth
                   
                  
                    <a  onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Logout</a>
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" src="{{ asset('admins/img/DefaultImage.png') }}" alt="" style="width: 40px; height: 40px;">
                ...
                <div class="bg-light rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="#">Citizen Complaints Management</a>, All Right Reserved. 
                        </div>
                        <div class="col-12 col-sm-6 text-center text-sm-end">
 
                            Designed By <a href="https://cky.rw">CK SOFTWARE INDUSTRY</a>
